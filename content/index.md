...
For some examples of Digital Gardens, see this [Digital Garden Inventory](https://medium.com/@raysims/a-digital-garden-inventory-d6450fe74b4).
...
I'm a big fan of cool note taking and mind maps, so when I discovered [Obsidian](https://obsidian.md/), the perfect tool for interlinked-note-taking, one thing led to another. For more info see [this article on Second Brain system](https://maggieappleton.com/basb) or the [Zettelkasten method](https://zettelkasten.de/overview/). 
...
- [[raccolta musicale|My music collection]], maybe the most curated plant in this garden as it's my primary hobby
